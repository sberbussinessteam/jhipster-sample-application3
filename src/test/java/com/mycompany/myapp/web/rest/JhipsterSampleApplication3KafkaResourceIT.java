...
class JhipsterSampleApplication3KafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleApplication3KafkaResource kafkaResource = new JhipsterSampleApplication3KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-application-3-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-application-3-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
